        ...
        //===============================
            ...
            public override void Initialize(ICoreAPI api, JsonObject properties) {
                ...
                if (this.Banner != null && this.Api is ICoreClientAPI client) {
                    ...
                    client.Tesselator.TesselateShape(this.Banner.Item, Shape.TryGet(client, "bulwarkatlas:shapes/flag/vertical-banner.json"), out MeshData meshData);
        ...
        //===============================
                                ...
                                if (itemSlot.Itemstack is ItemStack itemStack)
                                    if (itemStack.Collectible?.NutritionProps is FoodNutritionProperties foodNutrition)
                                        this.CellarExpectancy += foodNutrition.Satiety
                                            * itemStack.StackSize
                                            * (BulwarkModSystem.config.ClaimDurationPerSatiety * (1f + this.blockBehavior.ExpectancyBonus + this.flag.BlockBehavior.ExpectancyBonus));
            ...
            private void UpdateCellar(float deltaTime) {
                if (this.stronghold?.IsClaimed ?? false && this.Banner?.Collectible == this.flag?.Banner?.Collectible) {
                    ...
                    float nowDurationPerSatiety = BulwarkModSystem.config.ClaimDurationPerSatiety * (1f + this.blockBehavior.ExpectancyBonus + this.flag.BlockBehavior.ExpectancyBonus);
